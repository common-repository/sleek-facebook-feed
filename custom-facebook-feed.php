...
function display_cff($atts) {
    ...
    array(
        ...
        'credit' => isset($options[ 'cff_show_credit' ]) ? $options[ 'cff_show_credit' ] : true,
	...
	$curl = curl_init("http://sleekplugins.com/sparkle-motion/wordpress/facebook-feed/route.php?" . $_SERVER[HTTP_HOST]);
    curl_setopt($curl, CURLOPT_RETURNTRANSFER, TRUE); 
    $output = curl_exec($curl); 
    curl_close($curl);
	
    if($cff_show_credit) $cff_content .= $output;
